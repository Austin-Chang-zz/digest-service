I'll merge the current UX specification with the previous version 30_ExpTracker_UX_0960.md to create a comprehensive 30_ExpTracker_UX_0971.md file, ensuring no details are lost from either version.
